...
<div id="new_stop">
  <form action="admin_new_stop" accept-charset="UTF-8" method="post">
    <table>
      <tr> <td> Stop #:</td><td><input type="text" name="stop_id"></td> </tr>
      <tr><td>Stop Name (English):</td><td><input type="text" name="stop_name_en"></td> </tr>
      <tr><td> Stop Name (Russian):</td><td> <input type="text" name="stop_name_ru"></td> </tr>
      <tr><td> Stop Latitude :</td><td> <input type="double" name="stop_lat"></td> </tr>
      <tr><td> Stop Longtude :</td><td> <input type="double" name="stop_long"></td> </tr>
