...
<h3>Assign stops for Route # <c:out value="${route_id}"></c:out></h3>
<br>
<c:choose>
<c:when test="${not empty admin}">
<div id="list_stops">
  <form action="admin_ass_stop" accept-charset="UTF-8" method="post">
  <table style="margin: auto">
    ...
    <c:forEach items="${all_stops}" var="stop">
      <tr>
        ...
        <td><input type="submit" class="button-accept" name="${stop.STOP_ID()}" value="Assign stop for route"></td>
       </tr>
    </c:forEach>
    <tr><hr></tr>
    <tr></tr>
