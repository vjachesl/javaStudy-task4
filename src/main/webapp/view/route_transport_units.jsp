                ...
                <table style="margin: auto">
                    ...
                    <c:forEach items="${transportUnits}" var="unit">
                        <tr>
                            ...
                            <td></td>
                            <td><c:out
                                    value="${language eq 'ru' ? unit.MODEL_NAME_RU() : unit.MODEL_NAME_EN()}"></c:out></td>
                            <td></td>
                            <td><c:out
                                    value="${language eq 'ru' ? unit.TRANSPORT_TYPE().getNameRu() : unit.TRANSPORT_TYPE().getNameEn()}"></c:out></td>
                            <td></td>
                        </tr>
                    </c:forEach>
                </table>
