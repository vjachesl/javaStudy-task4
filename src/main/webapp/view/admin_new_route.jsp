...
<p>Beware! You can't add ROUTE with existing number and also all fields needs to be filled before pressing button
    "Add"</p>
...
<div id="new_route">
    <form action="admin_new_route" accept-charset="UTF-8" method="post">
        <table>
            <tr>
                <td> Route #:</td>
                <td><input type="text" name="route_id"></td>
            </tr>
            <tr>
                <td>Route Name (English):</td>
                <td><input type="text" name="route_name_en"></td>
            </tr>
            <tr>
                <td> Route Name (Russian):</td>
                <td><input type="text" name="route_name_ru"></td>
            </tr>
            <tr>
                <td>Route Transport Type(one of the next values: tram, trolleybus, bus):</td>
                <td><input type="text" name="route_transp_type"></td>
            </tr>
            <tr>
                <td></td>
