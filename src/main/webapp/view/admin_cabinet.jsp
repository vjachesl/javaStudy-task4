            ...
            <form action="admin_cabinet" accept-charset="UTF-8" method="post">
                <table style="margin: auto">
                    ...
                    <c:forEach items="${routes}" var="route">
                        <tr>
                            ...
                            <td><input type="submit" class="button-accept" name="admin_del_rout:${route.ROUTE_ID()}"
                                       value="Delete Route"></td>
                            <td><input type="submit" class="button-accept" name="admin_ass_stop:${route.ROUTE_ID()}"
                                       value="Add Stop to Route"></td>
                            <td><input type="submit" class="button-accept" name="admin_rem_stop:${route.ROUTE_ID()}"
                                       value="Remove Stop from Route"></td>
                            <td><input type="submit" class="button-accept" name="admin_ass_unit:${route.ROUTE_ID()}"
                                       value="Add Unit to Route"></td>
                            <td><input type="submit" class="button-accept" name="admin_rem_unit:${route.ROUTE_ID()}"
                                       value="Remove Unit from Route"></td>
                        </tr>
                    </c:forEach>
                    <tr>
                        <hr>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="submit" class="button-accept" name="admin_new_route" value="Add new Route">
                        </td>
                        ...
                        <td><input type="submit" class="button-accept" name="admin_list_units"
                                   value="List of all Units"></td>
                        <td><input type="submit" class="button-accept" name="admin_list_stops"
                                   value="List of all stops"></td>
                    </tr>
                </table>
            </form>
        </c:otherwise>
