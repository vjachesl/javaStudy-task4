...
<h3>Removing Units from Route # <c:out value="${route_id}"></c:out></h3>
<br>
<c:choose>
<c:when test="${not empty admin}">
<div id="list_units">
  <form action="admin_rem_unit" accept-charset="UTF-8" method="post">
  <table style="margin: auto">
    ...
    <c:forEach items="${route_units}" var="unit">
      <tr>
        ...
        <td><input type="submit" class="button-accept" name="${unit.UNIT_ID()}" value="Remove unit from route"></td>
       </tr>
    </c:forEach>
    <tr><hr></tr>
    <tr></tr>
