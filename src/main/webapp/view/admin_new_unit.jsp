...
<p>Beware! You can't add UNIT with existing number and also all fields needs to be filled before pressing button
    "Add"</p>
...
<div id="new_unit">
    <form action="admin_new_unit" accept-charset="UTF-8" method="post">
        <table>
            ...
            <tr>
                <td>Unit Model Name (English):</td>
                <td><input type="text" name="unit_model_name_en"></td>
            </tr>
            <tr>
                <td>Unit Model Name (Russian):</td>
                <td><input type="text" name="unit_model_name_ru"></td>
            </tr>
            <tr>
                <td>Unit Transport Type(one of the next values: tram, trolleybus, bus):</td>
                <td><input type="text" name="unit_transp_type"></td>
            </tr>
